...
const Header = () => {
  ...
  return (
    <div className=" absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 flex flex-col md:flex-row justify-between overflow-hidden">
      ...
      {user && (
        <div className="flex  justify-between md:p-2">
          ...
          <button  onClick={handleGptSearchClick} className="md:py-2 px-2 mx-4 my-2 bg-purple-800 text-white rounded-xl">
            {showGptSearch ? "Home" : "GPT Search"}
          </button>
          <img
            className="hidden md:block w-10 h-10 m-2 rounded-xl"
          ...
          <button
            ...
            className=" bg-red-700 m-2 p-2 rounded-xl text-white"
          >
            Sign Out
          </button>
        </div>
